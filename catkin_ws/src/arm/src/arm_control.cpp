...
// TODO Fix the code so that it doesn't use the time server.
//    if (time_client_.call(end_check))
//    {
...
//            printf("Duration of move : %f\n", end_check.response.delta.toSec());
            ...
            //TODO This is a hack around the time server, all motions are performed for
            // 0.1 second, and then end. This is because the activation vector controller
            // checks what it should do every 0.2 seconds
