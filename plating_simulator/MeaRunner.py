...
class meaRunner:
    ...
    def runSim(self):
        ...
        #LIF is weaksauce, but runs faster than izhikevich
#         eqs = '''
#         dvm/dt = (ge+gi-(vm+49*mV))/(20*ms) : volt
#         dge/dt = -ge/(5*ms) : volt
#         dgi/dt = -gi/(10*ms) : volt
#         '''
#         
#         self.culture = NeuronGroup(self.neuronCount , eqs, threshold=-50*mV, reset=-60*mV)
#         self.culture.vm = -60 * mV + 10 * mV * rand(len(self.culture))
...
#                     Ci[connection[0], connection[1]] = -15*mV 
#                 else:
